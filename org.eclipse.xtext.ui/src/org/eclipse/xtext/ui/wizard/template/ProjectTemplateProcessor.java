...
public class ProjectTemplateProcessor extends TemplateProcessor {
	...
	@Override
	protected String getLabel(ClassDeclaration annotatedClass, CodeGenerationContext context) {
		return annotatedClass.findAnnotation(context.findTypeGlobally(ProjectTemplate.class)).getStringValue("label");
	}

	@Override
	protected String getDescription(ClassDeclaration annotatedClass, CodeGenerationContext context) {
