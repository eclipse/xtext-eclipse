...
public class RuleEngineQuickfixTest extends AbstractQuickfixTest {
  ...
  public void fix_invalid_rule_device_state() {
    ...
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("Rule \'rule1\' when Heater.error then");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("fire(Heater.off)");
    _builder_1.newLine();
    AbstractQuickfixTest.Quickfix _quickfix = new AbstractQuickfixTest.Quickfix("Change to \'Heater.error\'", "Change to \'Heater.error\'", _builder_1.toString());
    ...
    _builder_2.newLine();
    _builder_2.newLine();
    _builder_2.append("Rule \'rule1\' when Heater.off then");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("fire(Heater.off)");
    _builder_2.newLine();
    AbstractQuickfixTest.Quickfix _quickfix_1 = new AbstractQuickfixTest.Quickfix("Change to \'Heater.off\'", "Change to \'Heater.off\'", _builder_2.toString());
    ...
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("Rule \'rule1\' when Window.closed then");
    _builder_4.newLine();
    _builder_4.append("\t");
    _builder_4.append("fire(Heater.off)");
    _builder_4.newLine();
    AbstractQuickfixTest.Quickfix _quickfix_3 = new AbstractQuickfixTest.Quickfix("Change to \'Window.closed\'", "Change to \'Window.closed\'", _builder_4.toString());
    ...
    _builder_5.newLine();
    _builder_5.newLine();
    _builder_5.append("Rule \'rule1\' when Window.open then");
    _builder_5.newLine();
    _builder_5.append("\t");
    _builder_5.append("fire(Heater.off)");
    _builder_5.newLine();
    AbstractQuickfixTest.Quickfix _quickfix_4 = new AbstractQuickfixTest.Quickfix("Change to \'Window.open\'", "Change to \'Window.open\'", _builder_5.toString());
