 ...
 */
package org.eclipse.xtext.ui.tests.changeserializer.services;
...
@Singleton
public class ChangeSerializerGrammarAccess extends AbstractGrammarElementFinder {
	
	public class PackageDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.changeserializer.ChangeSerializer.PackageDeclaration");
	...
	public class ImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.changeserializer.ChangeSerializer.Import");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.changeserializer.ChangeSerializer.Element");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.changeserializer.ChangeSerializer.QualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public ChangeSerializerGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.xtext.ui.tests.changeserializer.ChangeSerializer".equals(grammar.getName())) {
				return grammar;
			}
