 ...
 * @generated
 */
public class ChangeSerializerPackageImpl extends EPackageImpl implements ChangeSerializerPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.ui.tests.changeserializer.changeSerializer.ChangeSerializerPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ChangeSerializerPackageImpl()
  {
    super(eNS_URI, ChangeSerializerFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link ChangeSerializerPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ChangeSerializerPackage init()
  {
    if (isInited) return (ChangeSerializerPackage)EPackage.Registry.INSTANCE.getEPackage(ChangeSerializerPackage.eNS_URI);

    // Obtain or create and register package
    ChangeSerializerPackageImpl theChangeSerializerPackage = (ChangeSerializerPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ChangeSerializerPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ChangeSerializerPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theChangeSerializerPackage.createPackageContents();

    // Initialize created meta-data
    theChangeSerializerPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theChangeSerializerPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ChangeSerializerPackage.eNS_URI, theChangeSerializerPackage);
    return theChangeSerializerPackage;
  }
   ...
   * @generated
   */
  public ChangeSerializerFactory getChangeSerializerFactory()
  {
    return (ChangeSerializerFactory)getEFactoryInstance();
  }
