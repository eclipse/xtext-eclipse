...
import org.eclipse.xtext.ui.tests.changeserializer.changeSerializer.ChangeSerializerFactory;
...
public class ChangeSerializerReferenceUpdater extends ReferenceUpdater {
  @Inject
  private IQualifiedNameProvider names;
  
  @Extension
  private ChangeSerializerFactory _changeSerializerFactory = ChangeSerializerFactory.eINSTANCE;
    ...
    if (((!toAdd.isEmpty()) || (!toDelete.isEmpty()))) {
      final Runnable _function_5 = () -> {
        ...
        final Consumer<Element> _function_7 = (Element e) -> {
          ...
          Import _createImport = this._changeSerializerFactory.createImport();
